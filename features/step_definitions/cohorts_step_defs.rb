...
When("There are cohorts available to edit") do
  pending # Write code here that turns the phrase above into concrete actions
end
...
When("I change the current specialization to the desired specialization") do
  pending # Write code here that turns the phrase above into concrete actions
end
...
When("I change the current name to the desired ") do
  pending # Write code here that turns the phrase above into concrete actions
end

When("I change the current specialization to the desired DevOps") do
  pending # Write code here that turns the phrase above into concrete actions
end
...
When("I change the current name to the desired Engineering{int}") do |int|
  pending # Write code here that turns the phrase above into concrete actions
end

When("I change the current specialization to the desired ") do
  pending # Write code here that turns the phrase above into concrete actions
end

When("I select a specialisation for my cohort") do
  pending # Write code here that turns the phrase above into concrete actions
end
...
When("I take one of the user's cohort") do
  pending # Write code here that turns the phrase above into concrete actions
end

When("I click the specified cohort") do
  pending # Write code here that turns the phrase above into concrete actions
end

Then("that cohort should not delete") do
  pending # Write code here that turns the phrase above into concrete actions
end
